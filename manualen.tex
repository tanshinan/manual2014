...
\newcommand{\rpt}{
        \raisebox{.2ex}{:}
        \hspace*{-0.5ex}\raisebox{-.4ex}{\rule{.1ex}{2.3ex}\,\rule{.1ex}{2.3ex}}}

\newcommand{\revrpt}{
        \raisebox{-.4ex}{\rule{.1ex}{2.3ex}\,\rule{.1ex}{2.3ex}}
        \hspace*{-0.5ex}\raisebox{.2ex}{: }}

%% chapter and section styling %%
\titleformat{\chapter}[hang]{}{}{0pt}{\centering\fontsize{30}{70}\rmfamily\textbf}
\titleformat{\section}[hang]{\rmfamily\fontsize{11}{15}\bfseries}{}{0pt}{\textbf}
...
\renewenvironment{theindex}
                 {{\noindent\rmfamily{\fontsize{11}{15}\textbf{TITEL och FÖRSTARADEN REGISTER}}\vspace*{10pt}\par\textbf{\normalsize Symboler}\par}
...
{\footnotesize\textit{Ur ``Vad är en datavetare egentligen''\\
    BlurGel nr \oldstylenums{0}, \oldstylenums{1995}}}
\clearpage
...
\cleardoublepage
\renewcommand{\contentsname}{\vspace{-2.17cm}\rmfamily{\fontsize{11}{15}\textbf{INNEHÅLL}}\vspace{-1.2cm}}
\tableofcontents
