...
\vspace{10pt}
\begin{tabular}{@{\hspace{6pt}}p{0.5\textwidth}p{0.5\textwidth}@{}}
...
\end{tabular}\par
\newpage
\noindent\hspace{10pt}Ett stort tack till alla de som donerat till
skapandet av denna manual och ett extra stort tack till Pu som skapat
alla illustrationer till kapitlena.\par
\vspace{10pt}
...
\null
\newpage
\noindent\hspace{10pt}Vi vill även tacka alla som hjälpte till med
skapandet av de äldre manualerna, utan ert arbete skulle denna bok
inte vara här idag.\par
\vspace{10pt}
\begin{tabular}{@{}p{0.5\textwidth}p{0.5\textwidth}@{}}
  ...
  Jens Bohlin & Jesper Wilhelmsson\\
  Joakim Lindqvist & Joakim Thörnkvist\\
  Jonas Högström & Kristiina Ausmees\\
  Lars Hägglund & Lars-Arne Mattson\\
  Martin Davidson & Mats Hägglund\\
  Mattias Hallberg & Micke Liljeblad\\
  Måns Engmem & Måns af Klercker\\
  NeNNe & Niclas Stensbäck\\
  Olof Appelblad & Olof Dahlberg\\
  Pär Mattsson & Sandra Nyström\\
  Sara Ingmar
\end{tabular}
%% \cleardoublepage
